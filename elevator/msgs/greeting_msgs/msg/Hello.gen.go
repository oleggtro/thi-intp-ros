...
#include <greeting_msgs/msg/hello.h>

*/
import "C"

func init() {
	typemap.RegisterMessage("greeting_msgs/Hello", HelloTypeSupport)
	typemap.RegisterMessage("greeting_msgs/msg/Hello", HelloTypeSupport)
}
...
func (t _HelloTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.greeting_msgs__msg__Hello
	return (unsafe.Pointer)(C.greeting_msgs__msg__Hello__create())
}

func (t _HelloTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.greeting_msgs__msg__Hello__destroy((*C.greeting_msgs__msg__Hello)(pointer_to_free))
}

func (t _HelloTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Hello)
	mem := (*C.greeting_msgs__msg__Hello)(dst)
...
func (t _HelloTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Hello)
	mem := (*C.greeting_msgs__msg__Hello)(ros2_message_buffer)
	primitives.StringAsGoStruct(&m.Name, unsafe.Pointer(&mem.name))
}

func (t _HelloTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__greeting_msgs__msg__Hello())
}

type CHello = C.greeting_msgs__msg__Hello
type CHello__Sequence = C.greeting_msgs__msg__Hello__Sequence
...
func Hello__Sequence_to_C(cSlice *CHello__Sequence, goSlice []Hello) {
	...
	cSlice.data = (*C.greeting_msgs__msg__Hello)(C.malloc(C.sizeof_struct_greeting_msgs__msg__Hello * C.size_t(len(goSlice))))
